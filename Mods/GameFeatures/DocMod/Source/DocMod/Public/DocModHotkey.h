...
/**
 * Configurable hotkey (default F6 - see UDocModDeveloperSettings::HotkeyKey,
 * Project Settings > Plugins > DocMod, or Config/DefaultDocMod.ini):
 * prints the manufacturer the local player is currently looking at (via
 * GetTargetedManufacturer, same as DocMod.Target / /docmod target) and,
