...
/**
 * Localhost-only JSON RPC transport for the DocMod AI interface.
 *
 ...
 * comment in DocModFunctionLibrary, not to this class comment.
 *
 ...
 * narrowly scoped, delegating to a real UDocModFunctionLibrary function.
 *
