...
#include "AIModChatCommand.generated.h"

/**
 * In-game chat command for the AIMod AI interface: `/aimod <subcommand>`
 * (SML's chat command framework - see
 * Mods/SML/Source/SML/Public/Command/ChatCommandInstance.h). Lets a
 * player trigger AIMod telemetry/self-test reporting directly from the
 ...
 *
 * NOT auto-registered - unlike AIModSelfTest's automatic
 ...
 */
UCLASS()
class AIMOD_API AAIModChatCommand : public AChatCommandInstance
{
	GENERATED_BODY()
